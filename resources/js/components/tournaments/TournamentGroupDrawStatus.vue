...
<template>
    ...
    >
        ...
        <p class="mt-1 text-sm">
            Sva mesta u grupama su popunjena. Možeš da se vratiš na
            pregled turnira ili da pregledaš grupe ispod.
        </p>
    ...
    >
        ...
        <p class="mt-1 text-sm">
            Pre unosa učesnika moraš da podesiš broj grupa i broj mesta
            po grupi.
        </p>
