...
<template>
    <div>
        <div>
            <h2 class="text-lg font-medium">Pravila prolaza</h2>

            <p class="mt-1 text-sm text-muted-foreground">
                Ova podešavanja utiču na status u tabeli grupa: Direktan prolaz,
                Repasaž ili Ispao.
            </p>
        </div>
        ...
        <div class="mt-5 space-y-5">
            <div>
                ...
                <p class="mt-1 text-xs text-muted-foreground">
                    Primer: ako staviš 2, prva dva iz svake grupe imaju status
                    Direktan prolaz.
                </p>
                ...
                <label class="flex items-start gap-3">
                    ...
                    <span>
                        ...
                        <span class="mt-1 block text-xs text-muted-foreground">
                            Ako je uključeno, učesnici koji nisu direktno prošli
                            biće označeni kao Repasaž. Ako nije uključeno, biće
                            označeni kao Ispao.
                        </span>
                    </span>
                </label>
            ...
            <div>
                ...
                <p class="mt-1 text-xs text-muted-foreground">
                    Ovaj broj se deli ravnomerno po grupama. Primer: 8 grupa i
                    ukupno 8 u repasažu znači da iz svake grupe još 1 učesnik
                    ide u repasaž.
                </p>
            ...
            <div>
                ...
                <p class="mt-1 text-xs text-muted-foreground">
                    Ovo još ne koristimo za generisanje repasaža, ali ga čuvamo
                    za sledeći korak.
                </p>
