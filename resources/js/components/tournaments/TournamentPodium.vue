...
<template>
    <div class="rounded-xl border border-emerald-500/30 bg-emerald-500/10 p-5 text-emerald-900 dark:text-emerald-100">
        ...
        <div class="mt-5 grid gap-3 md:grid-cols-2 xl:grid-cols-4">
            <div class="rounded-xl border border-emerald-500/30 bg-background/70 p-4">
                ...
                <p
                    v-if="podium.champion?.group_position"
            ...
            <div class="rounded-xl border border-sidebar-border/70 bg-background/70 p-4 dark:border-sidebar-border">
                ...
                <p
                    v-if="podium.second_place?.group_position"
                    class="mt-1 text-sm text-muted-foreground"
                >
            ...
            <div class="rounded-xl border border-sidebar-border/70 bg-background/70 p-4 dark:border-sidebar-border">
                ...
                <p
                    v-if="podium.third_place?.group_position"
                    class="mt-1 text-sm text-muted-foreground"
                >
            ...
            <div class="rounded-xl border border-sidebar-border/70 bg-background/70 p-4 dark:border-sidebar-border">
                ...
                <p
                    v-if="podium.fourth_place?.group_position"
                    class="mt-1 text-sm text-muted-foreground"
                >
